...
using SimpleBlog.Application.Features.ExtendedAttributes.Commands.AddEdit;
using SimpleBlog.Application.Features.ExtendedAttributes.Commands.Delete;
using SimpleBlog.Application.Features.ExtendedAttributes.Queries.Export;
using SimpleBlog.Application.Features.ExtendedAttributes.Queries.GetAll;
using SimpleBlog.Application.Features.ExtendedAttributes.Queries.GetAllByEntityId;
using SimpleBlog.Application.Features.ExtendedAttributes.Queries.GetById;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static void AddExtendedAttributesHandlers(this IServiceCollection services)
        {
            var extendedAttributeTypes = typeof(IEntity)
                ...
                .Where(t => t.BaseGenericType?.GetGenericTypeDefinition() == typeof(AuditEntityExtendedAttribute<,,>))
                .ToList();
