...
namespace SimpleBlog.Infrastructure.Repositories
{
    public class UnitOfWork<TId> : IUnitOfWork<TId>
    {
        ...
        public UnitOfWork(DbContext dbContext, ICurrentUserService currentUserService, IAppCache cache)
        {
        ...
        public IRepositoryAsync<TEntity, TId> Repository<TEntity>() where TEntity : AuditEntity<TId>
        {
