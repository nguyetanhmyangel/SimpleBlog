...
{
    public class ExtendedAttributeUnitOfWork<TId, TEntityId, TEntity> : 
        IExtendedAttributeUnitOfWork<TId, TEntityId, TEntity> where TEntity : AuditEntity<TEntityId>
    {
        ...
        public ExtendedAttributeUnitOfWork(DbContext dbContext, ICurrentUserService currentUserService, IAppCache cache)
        {
        ...
        public IRepositoryAsync<T, TId> Repository<T>() where T : AuditEntityExtendedAttribute<TId, TEntityId, TEntity>
        {
